...
class image_funcs(object):
    ...
    def get_image(self, cells, width, height, xpos, ypos,
                  pic):  # Returns 1 image depending on it's dimensions and position
    ...
    def get_images(self, cells, width, width2, height, xpos, ypos,
                   pic):  # Returns a list of images based on how many images
